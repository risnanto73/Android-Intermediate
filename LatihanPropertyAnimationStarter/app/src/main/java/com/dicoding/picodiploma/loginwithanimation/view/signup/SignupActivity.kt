...
class SignupActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        ...
        val together = AnimatorSet().apply {
            playTogether(titleTextView)
        }


        AnimatorSet().apply {
            playSequentially(nameTextView, nameEditText, nameEditTextLayout, emailTextView, emailEditTextLayout, emailEditText, passwordTextView, passwordEditTextLayout, passwordEditText, signupButton, together)
            start()
        }
    }
