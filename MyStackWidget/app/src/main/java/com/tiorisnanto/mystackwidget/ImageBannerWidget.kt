package com.tiorisnanto.mystackwidget
...
class ImageBannerWidget : AppWidgetProvider() {
    ...
    companion object {
        private const val TOAST_ACTION = "com.tiorisnanto.picodiploma.TOAST_ACTION"
        const val EXTRA_ITEM = "com.tiorisnanto.picodiploma.EXTRA_ITEM"
