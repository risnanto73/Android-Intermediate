...
class FirebaseMessageAdapter (
    options: FirebaseRecyclerOptions<MainActivity.Message>,
    private val currentUserName: String?
) : FirebaseRecyclerAdapter<MainActivity.Message, FirebaseMessageAdapter.MessageViewHolder>(options){
    ...
    override fun onBindViewHolder(holder: MessageViewHolder, position: Int, model: MainActivity.Message) {
        holder.bind(model)
    }
    inner class MessageViewHolder(private val binding: ItemMessageBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(item: MainActivity.Message) {
