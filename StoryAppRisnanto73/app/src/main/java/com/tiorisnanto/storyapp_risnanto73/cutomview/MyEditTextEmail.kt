package com.tiorisnanto.storyapp_risnanto73.cutomview
...
class MyEditTextEmail: TextInputEditText, View.OnTouchListener {
    ...
    private fun init() {
        clearButton = ContextCompat.getDrawable(context, R.drawable.ic_baseline_clear_24) as Drawable // x button
            ...
            if (isClearButtonClicked) {
                return when (event.action) {
                    MotionEvent.ACTION_DOWN -> {
                        clearButton = ContextCompat.getDrawable(context, R.drawable.ic_baseline_clear_24) as Drawable
